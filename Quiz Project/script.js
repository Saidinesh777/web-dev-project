(function($) {
    var colors = ['#3E5151', '#27ae60', '#2c3e50', '#f39c12', '#e74c3c', '#9b59b6', '#FB6964', "#472E32", "#FF4136", "#39CCCC", "#BDBB99", "#77B1A9", "#73A857"];
    var username = '';
    var myColor;
    var all_questions = [{
        question_string: "Javascript is _________language.",
        choices: {
            correct: "Scripting",
            wrong: ["Programming", "Application", "None of These"]
        }
    }, {
        question_string: "JavaScript is ________ Side Scripting Language.",
        choices: {
            correct: "Browser",
    ...
    Quiz.prototype.render = function(container) {
        ...
        $('#submitButton').click(function() {
            ...
            $('.percentage span').text(percentage*100);
            ...
            $('.score-label h1').html('Hi ' + username + ', ' + 'Your Score is <i class="smiley"></i>');
